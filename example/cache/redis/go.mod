...
require (
	...
	github.com/rookie-ninja/rk-cache/redis v1.2.12
...
require (
	...
	github.com/rookie-ninja/rk-db/redis v1.2.12 // indirect
	github.com/rookie-ninja/rk-entry/v2 v2.2.20 // indirect
