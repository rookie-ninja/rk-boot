...
require (
	...
	github.com/rookie-ninja/rk-boot/v2 v2.0.2
	github.com/rookie-ninja/rk-cache/redis v1.0.0
	github.com/rookie-ninja/rk-gin/v2 v2.0.2
)
...
require (
	...
	github.com/rookie-ninja/rk-db/redis v1.0.1 // indirect
